 ...
 <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
   <div class="container">
   <a href="<?php echo base_url('index.php/Client');?>" class="navbar-brand">
     ...
     <div class="collapse navbar-collapse order-3" id="navbarCollapse">
       ...
       <ul class="navbar-nav">
         <li class="nav-item">
           <a href="<?php echo base_url('index.php/Client');?>" class="nav-link">Inicio</a>
         </li>
         <li class="nav-item">
           <a href="<?php echo base_url('index.php/Client/message');?>" class="nav-link">Mensajes</a>
         </li>
